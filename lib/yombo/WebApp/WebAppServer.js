...
function WebAppServer( log, translation ) {
...
WebAppServer.prototype.start = function( config, listener ) {
    ...
    if ( this.inited ) {
        this.log( this.translation[ "warning already running" ] );
        return;
    }
    ...
    this.app.get( '/favicon.png', function( req, res ) {
        ...
        res.sendFile( scope.pathJoin( __dirname, '../../../../public/favicon.png' ) );

    } );

    // Serve all public content
    this.mapDirectory( "/public", this.pathJoin( "../../../../public" ) );
...
WebAppServer.prototype.onClientConnectionInternal = function( socket, req ) {
    ...
    this.listener.onClientConnection( client, req );
